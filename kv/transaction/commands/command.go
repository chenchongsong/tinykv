...
type Command interface {
	...
	Read(txn *mvcc.MvccTxn) (interface{}, [][]byte, error)
...
func RunCommand(cmd Command, storage storage.Storage, latches *latches.Latches) (interface{}, error) {
	...
	if keysToWrite == nil {
		...
		txn := mvcc.MvccTxn{Reader: reader, StartTS: cmd.StartTs()}
...
func (base CommandBase) Read(txn *mvcc.MvccTxn) (interface{}, [][]byte, error) {
	return nil, nil, nil
}
